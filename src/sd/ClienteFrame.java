...
public class ClienteFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        System.out.println("Usuarios : "+ this.txtName.getText());
        comboBox = new JComboBox();
        comboBox.addItem("------ Selecione um Usuario Online ------");
        comboBox.addItem("Andre");
        comboBox.addItem("Maria");
        comboBox.addItem("Nat");
        jPanelUserOnline.add(comboBox);

        
		
		 jPanel2.setBorder(javax.swing.BorderFactory.
		 createTitledBorder("Usuarios Onlines"));
		 ...
		 .addComponent(jScrollPane3, javax.swing.GroupLayout.DEFAULT_SIZE, 80,
		 Short.MAX_VALUE) .addContainerGap()) ); jPanel2Layout.setVerticalGroup(
		 jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jScrollPane3) );
        			...
        			.addGroup(layout.createParallelGroup(Alignment.LEADING)
        				.addGroup(layout.createSequentialGroup()
        					...
        					.addGroup(layout.createParallelGroup(Alignment.TRAILING)
        						.addComponent(jPanel3, GroupLayout.DEFAULT_SIZE, 328, Short.MAX_VALUE)
        						.addComponent(jPanel1, GroupLayout.DEFAULT_SIZE, 328, Short.MAX_VALUE))
        					.addGap(18))
        				.addGroup(layout.createSequentialGroup()
        					.addComponent(jPanelUserOnline, GroupLayout.DEFAULT_SIZE, 350, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
        	layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(layout.createSequentialGroup()
        			.addGroup(layout.createParallelGroup(Alignment.LEADING)
        				.addGroup(layout.createSequentialGroup()
        					.addComponent(jPanel1, GroupLayout.PREFERRED_SIZE, 72, GroupLayout.PREFERRED_SIZE)
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addComponent(jPanel3, GroupLayout.PREFERRED_SIZE, 237, GroupLayout.PREFERRED_SIZE)
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addComponent(jPanelUserOnline, GroupLayout.DEFAULT_SIZE, 84, Short.MAX_VALUE))
  ...
  //inicio variaveis de Painel
    private JPanel jPanelUserOnline;
